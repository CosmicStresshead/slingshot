...
# Adjust import paths to include the 'slingshot' package from the 'src' directory
sys.path.append(os.path.join(os.path.dirname(__file__), ".."))  # Add 'src' directory to the sys.path
...
def main():
    ...
    if not os.path.exists(path):
        os.mkdir(path)
    log_file_path = os.path.join(path, "logfile.txt")
